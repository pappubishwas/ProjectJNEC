  ...
  <div id="page-wrapper">
    ...
    <div class="card">
          <div class="card-header">
            <h4 class="alert alert-info">Manage Student Accounts Details</h4>
          </div>
    <div class="card-body">
      <div class="row">
          ...
          <table id="sliderDetails" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th>Gender</th>
                  <th>Programme</th>
                  <th style="display: none">Student Status</th>
                  <th>Status(Student Affairs)</th>
                  <th>Status(Exam Cell)</th>
                  <th>Status(Account Section)</th>
                  <th>Action</th>
                </tr>
              </thead>
              <?php
              ...
              <tbody>
                  <tr>
                    ...
                    <td style="display: none"><?php echo $row["std_status"]; ?></td>
                    <td><?php echo $row["sa_status"]; ?></td>
                    <td><?php echo $row["examcell_status"]; ?></td>
                    <td><?php echo $row["account_status"]; ?></td>
                    <td>
                       <button type="button" class="btn btn-info btn-block"><a href="update-account.php?Id=<?php echo $row["Id"]; ?>">Update</button>
                    </td>
                  </tr>
              </tbody>
              <?php $i++;} ?>
