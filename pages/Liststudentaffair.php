    ...
    <br>
     <div class="card">
          <div class="card-header">
            <h4 class="alert alert-info">Manage Student Affairs Details</h4>
          </div>
    <div class="card-body">
      <div class="row">
          ...
          <table id="sliderDetails" class="table table-bordered table-striped">
              ...
              <tbody>
                  <tr>
                    ...
                    <td>
                       <button type="button" class="btn btn-info btn-block" ><a href="update-sa.php?Id=<?php echo $row["Id"]; ?>">Update</button>
                    </td>
                  </tr>
              </tbody>
