...
if(count($_POST)>0) {
mysqli_query($con,"UPDATE t_student set Id='" . $_POST['Id'] . "', std_name='" . $_POST['std_name'] . "', std_number='" . $_POST['std_number'] . "', std_program='" . $_POST['std_program'] . "' ,sa_status='" . $_POST['Role_Id'] . "' WHERE Id='" . $_POST['Id'] . "'");
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="form-group row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <select name="Role_Id" id="Role_Id" class="form-control" placeholder="Role" value="<?php echo $row['sa_status']; ?>">
